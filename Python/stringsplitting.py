##### Splitting strings.
########## This is not string theory, despite the title.
...
The hip hip a hop, and you don't stop the rockin'
To the bang bang boogie say up jump the boogie
To the rhythm of the boogie the beat
...
The beat don't stop until the break of dawn
I'm sayin' on'n'n'on'n' on on'n'on
...
print(text.split())     #Splits the string into words.

word_count = {}
"""
for word in text.split():
    ##### Prints the text. It's the lyrics to Rapper's Delight so it's fucking huge.
    print(word)   
"""
for word in text.lower().split():   #Uppercase and lowercase versions of words counted as one.
